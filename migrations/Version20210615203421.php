 ...
 */
final class Version20210615203421 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE job (id INT AUTO_INCREMENT NOT NULL, id_recruteur_id INT DEFAULT NULL, date DATE NOT NULL, type VARCHAR(255) NOT NULL, missiontitle VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, companyname VARCHAR(255) NOT NULL, INDEX IDX_FBD8E0F898C92C83 (id_recruteur_id), FULLTEXT INDEX IDX_FBD8E0F85F51A47F6DE4402617BBE3948CDE5729 (missiontitle, description, companyname, type), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
